...
const CategorySelation = ({onSelectedCategory, activeCategory}) => {
    const categories = ["Tech", "Apps", "Health", "Fintech", "Startups","AI", "Security", "Enterprise", "Growth", "Work", "Gadgets"]


  return (
    <div className='px-4 mb-8 lg:space-x-10 flex flex-wrap items-center justify-between border-b-2 py-5 text-gray-900 font-semibold'>
